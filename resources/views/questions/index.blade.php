                    ...
                    <x-table>
                        ...
                        <x-slot name="tbody">
                            ...
                            <tr>
                                ...
                                <td class="p-2 text-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                ...
                                <td class="p-2 text-center bg-transparent border-b whitespace-nowrap shadow-transparent">
                                    <p class="px-2 mb-0 leading-tight text-xs text-slate-700">{{ $question->question }}</p>
                                </td>
